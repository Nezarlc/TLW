...
async function main() {
  ...
  const myKeypair = loadWalletKey("/home/usuario/.config/solana/id.json");
  // Specify the mint (token) public key
  const mint = new web3.PublicKey(
    "3EkhwiWmsdzdTYhBtnW8kDoM9khvEZ96WyUkotqmg6Kd"
  );
  ...
  const ourMetadata = {
    name: "TheLastWar2",
    symbol: "TLW",
    uri: "https://raw.githubusercontent.com/Nezarlc/TLW/8f47912d9c77f7fa8e3c6f0dd1c5776c8eb82c23/TLW.png",
